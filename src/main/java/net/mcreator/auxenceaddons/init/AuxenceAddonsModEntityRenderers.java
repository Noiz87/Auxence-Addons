...
import net.mcreator.auxenceaddons.client.renderer.CapiNoizRenderer;
...
public class AuxenceAddonsModEntityRenderers {
	public static void load() {
		...
		EntityRendererRegistry.register(AuxenceAddonsModEntities.CAPI_NOIZ, CapiNoizRenderer::new);
	}
}
